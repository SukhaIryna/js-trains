...
console.log("isPositiveNumber(-2)", isPositiveNumber(-2));
...
// Задача 5: Напишіть функцію, яка перевіряє, чи є заданий рядок пустим. Використовуйте умовний оператор та властивість довжини рядка str.length для перевірки.
...
console.log("checkDataType(42)", checkDataType(42));
console.log("checkDataType('Hello')", checkDataType("Hello"));
console.log("checkDataType(true)", checkDataType(true));
console.log("checkDataType(undefined)", checkDataType(undefined));
...
console.log("findMax(10, 5)", findMax(10, 5));
console.log("findMax(8,12)", findMax(8, 12));
console.log("findMax(7, 7)", findMax(7, 7));
...
console.log("getUserStatus(15)", getUserStatus(15));
console.log("getUserStatus(25)", getUserStatus(25));
console.log("getUserStatus(70)", getUserStatus(70));
...
console.log("getDayOfWeek(1)", getDayOfWeek(1));
console.log("getDayOfWeek(3)", getDayOfWeek(3));
console.log("getDayOfWeek(6)", getDayOfWeek(6));
console.log("getDayOfWeek(8)", getDayOfWeek(8));
...
console.log("getVariableType(10)", getVariableType(10));
console.log('getVariableType("Hello")', getVariableType("Hello"));
console.log("getVariableType(true)", getVariableType(true));
console.log("getVariableType([1, 2, 3])", getVariableType([1, 2, 3]));
...
console.log("getAdder(10)", getAdder(10));
console.log("makeAdder(5)(10)", makeAdder(5)(10));
...
console.log("getDivider(10)", getDivider(10));
console.log("divide(2)(10)", divide(2)(10));
...
console.log("squareArea(5)", squareArea(5));
console.log("squareArea(5)", squareArea(5));
console.log("squareArea(6)", squareArea(6));
console.log("squareArea(6)", squareArea(6));
...
console.log("createCompose(5)", createCompose(5));
